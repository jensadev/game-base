...
import terrainUrl from '../assets/sprites/Terrain (32x32).png'
export default class First extends Map {
  constructor(game) {
    ...
    this.addPlatform(new Platform(game, 0, 450, 300, 50, ground))
    this.addPlatform(new Platform(game, 350, 450, 4000, 50, ground))
